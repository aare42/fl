...
const seedData = {
  organizations: [
    { name: 'ФінансБанк', description: 'Провідний банк для навчання фінансової грамотності' },
    { name: 'КейсБанк', description: 'Цифровий банк для освітніх цілей' },
    { name: 'НавчальнийБанк', description: 'Банківська установа для практичного навчання' },
    { name: 'ОсвітнійБанк', description: 'Спеціалізований навчальний фінансовий інститут' },
  ],
